...
def random_component_by_score(component_type, component_map):
    ...
    # From redis, get the hash the sum total score for the given component_type
    ...
    for name in names:
        ...
        avg = score / count
        # Prevents a single bad vote from pushing the score down to 0
...
def score_conversation(
    ...
    # "Hash increment by" for x table, for y key, increment by z score
